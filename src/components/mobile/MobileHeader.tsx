    ...
    <header className="sticky top-0 z-40 border-b border-line bg-brand px-4 pb-2.5 pt-3">
      <div className="flex items-center justify-between gap-3">
        ...
        <a
          ...
          className="inline-flex min-h-9 shrink-0 items-center justify-center rounded-full border border-canvas/80 px-3.5 py-1.5 font-mono text-xs uppercase tracking-[0.2em] text-canvas transition-colors duration-200 hover:bg-canvas hover:text-brand"
        >
          View CV
        </a>
      </div>
        ...
        {navItems.map((item) => {
          ...
          return (
            <a
              ...
              className={`motion-ui inline-flex min-h-9 shrink-0 items-center whitespace-nowrap rounded-md px-3 py-1.5 text-xs font-medium uppercase tracking-[0.14em] ${
