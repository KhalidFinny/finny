...
-- Recreate from local schema (parents first)
...
, cv_path TEXT NOT NULL DEFAULT '/CV%20-%20Muhammad%20Khalid%20Atthoriq.pdf');
...
CREATE TABLE projects (
  ...
  link TEXT,
  sort_order INTEGER NOT NULL DEFAULT 0
, role TEXT NOT NULL DEFAULT '', stack TEXT NOT NULL DEFAULT '', year TEXT NOT NULL DEFAULT '', source_link TEXT, gallery TEXT NOT NULL DEFAULT '[]', status TEXT NOT NULL DEFAULT 'done' CHECK (status IN ('ongoing', 'done')));
